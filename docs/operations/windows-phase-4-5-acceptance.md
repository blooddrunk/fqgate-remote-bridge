...
| T6  | Unauthenticated access to the admin hostname is challenged/denied by Access.                                                                                                                                                                        | PASS               | 2026-09-18 `phase45-acceptance.ps1`: ordinary and admin public URLs both returned HTTP 302 without following the redirect                                                                                                   |
...
Current decision: **KEEP OPEN**. T1–T3, T6, T7, and T16 are now evidenced on the
Windows 11 x64 host. The new `phase45-acceptance.ps1` helper passed the local
