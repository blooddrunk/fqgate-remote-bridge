...
Implement and close **Phase 6-A only** in `blooddrunk/fqgate-remote-bridge`.
...
inspect/plan, existing Phase 5-C local + real remote-machine regression, and final Ubuntu/Windows
